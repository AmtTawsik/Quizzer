...
const Footer = () => {
    ...
    return (
        <footer className="text-gray-500 bg-cyan-100 mt-10 px-4 py-5 mx-auto">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <p className="leading-relaxed mt-2 text-[20px] font-serif font-bold text-fuchsia-700">
                Welcome to the world’s largest quiz community.Take these quizzes at QUIZZER to test your knowledge on a variety of fun.
                </p>
            </div>
            <ul className="items-center justify-center mt-8 space-y-5 sm:flex sm:space-x-4 sm:space-y-0">
                {
                    footerNavs.map((item,idx) => (
                        <li key={idx} className="text-2xl font-bold text-pink-500 hover:text-pink-800">
                            <Link to={item.href}>
                                { item.name }
                            </Link>
                        </li>
            ...
            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2022 QUIZZER All rights reserved.
                </div>
